                                                    ...
                                                    <div id="existing-photos" class="d-flex flex-row flex-wrap gap-4">
                                                        @foreach($caseImages as $index => $image)
                                                            <div class="d-flex flex-column align-items-center" id="image-container-{{ $image->IMG_No }}">
                                                                <!-- Gambar + Overlay -->
                                                                <a class="d-block overlay" data-fslightbox="lightbox-case-images" 
                                                                    ...
                                                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-100px"
                                                                        style="background-image:url('{{ asset('storage/case_photos/' . str_replace(['/', '\\'], '-', $case->Case_No) . '/' . $image->IMG_Filename) }}'); width: 100px; height: 120px;">
                                                                    </div>
                        ...
                        <form action="" method="POST" id="caseForm" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="fv-row mb-5 col-12">
                                                ...
                                                <div class="d-flex flex-column align-items-center">
                                                    ...
                                                    <a class="d-block overlay" data-fslightbox="lightbox-case-images" 
                                                        ...
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                                            style="background-image:url('{{ asset('storage/case_photos/' . str_replace(['/', '\\'], '-', $case->Case_No) . '/' . $image->IMG_Filename) }}'); width: 300px; height: 320px;">
                                                        </div>
                                                        <!--end::Image-->
                                    ...
                                    @else
                                        <div class="alert alert-info mt-2">No photos uploaded yet.</div>
                                    @endif
                                </div>
